...
export default function MySpeaker() {
  const data = [
    {
      src: "/img/p_1/sb1.png",
      title: "Stories",
  ...
  return (
    <>
      <Navbar
        ...
        className="text-neutral-700 dark:text-neutral-200 bg-white dark:bg-neutral-800 relative z-10"
      ...
      <TextContainer
        ...
        inner={{
          ...
          bgColor: "bg-stone-100 dark:bg-neutral-900 text-black dark:text-neutral-200",
        }}
      >
        <H1>Fictional Object: MySpeaker</H1>

        <div className="bg-white dark:bg-neutral-800 p-5 md:p-10 lg:p-20 rounded-2xl mb-10 md:mb-20 shadow-lg">
          ...
          <div className="text-sm md:text-lg tracking-widest max-w-3xl mx-auto text-neutral-700 dark:text-neutral-200">
