...
export default function Project1Prep() {
  return (
    <>
      <AuroraBackground />
      <Navbar
      ...
      >
        ...
        <section>
          ...
          >
            ...
            <div>
              I&apos;m very susceptible to insomnia. I wouldn&apos;t be able to
              sleep if I heard a little voice, especially snoring.
              Unfortunately, my roommate snores. He always sleeps before me and
              stops me from sleeping by snoring. A pair of earplugs is necessary
              for me.
            </div>
            <div>
              <Image
            ...
            <div>
              ...
              use it to express my thoughts and personality since I don&apos;t
              like talking. I also use it to record some weird vision or dreams
              I encountered. It is like an alternate way to express myself.
            </div>
            <div>
              <Image
                alt={""}
                src={"/img/p_1/mouth.jpg"}
                width={300}
                height={300}
              ></Image>
            </div>
            <div>
              ...
              form. It&apos;s made of stretchable and compressible materials.
              It&apos;s meant to be opened, like a door. Someone won&apos;t
              encounter the object, or even feel its existence. It&apos;s a part
              of them and they have been one since they were born. Others need
              to read its manual, fearing that it would break. It is an
              amplifier of emotions and the major way for me to attain social
              experience.
            </div>
            <div>
              I&apos;m unsatisfied with my articulation. I&apos;m used to
              talking to myself at a low volume only I could hear. I&apos;m also
              used to using this volume when I&apos;m talking to other people.
              Meanwhile, the pitch of my voice is also very low. I often feel
              that I can&apos;t express what I want to say. When I bring up a
              conversation, people usually respond: &quot;What did you
              say?&quot; This object shaped my personality as it is now.
            </div>
          </Grid>
        </section>
        ...
        <section>
          ...
          >
            <Image
              alt={""}
              src={"/img/p_1/speaker.jpg"}
              width={300}
              height={300}
            ></Image>
            <Image
              alt={""}
              src={"/img/p_1/mask.jpg"}
              width={300}
              height={300}
            ></Image>
            <Image
